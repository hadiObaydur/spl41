...
//                                Toast.makeText(getContext(),""+removeFristItem.size(),Toast.LENGTH_LONG).show();
//                                for(int i=0;i<removeFristItem.size();i++){
//                                    for(int j=0;j<blockSources.size();j++) {
//                                        //String s=blockSources.get(j).replace('-',' ');
//                                        if ( removeFristItem.get(i).getSourceOfArticle().getName().equalsIgnoreCase(blockSources.get(j))){
//                                            removeFristItem.remove(i);
//                                            i--;
//                                            Toast.makeText(getContext(),""+removeFristItem.size()+"aaaa",Toast.LENGTH_LONG).show();
//
//                                            break;
//                                        }
//                                    }
...
//                                    for(int j=0;j<blockSources.size();j++) {
//                                        String s=blockSources.get(j).replace('-',' ');
//                                        if ( removeFristItem.get(i).getSourceOfArticle().getName().equalsIgnoreCase(s)){
//                                            removeFristItem.remove(i);
